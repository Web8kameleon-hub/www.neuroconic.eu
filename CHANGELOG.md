...
commits merged into `main` since `v1.0.31`. See
`docs/releases/v1.0.32.md` for full detail.

### Commits included (v1.0.32)

- `b5b800d fix(ci): keep production deploy manual`
...
Automated patch release cut by `scripts/release/auto_release.py` from
commits merged into `main` since `v1.0.29`. See
`docs/releases/v1.0.30.md` for full detail.

### Commits included (v1.0.30)

- `a1d6678 Retry transient think smoke during rolling deploy`
...
Automated patch release cut by `scripts/release/auto_release.py` from
commits merged into `main` since `v1.0.28`. See
`docs/releases/v1.0.29.md` for full detail.

### Commits included (v1.0.29)
...
Automated patch release cut by `scripts/release/auto_release.py` from
commits merged into `main` since `v1.0.25`. See
`docs/releases/v1.0.26.md` for full detail.

### Commits included (v1.0.26)

- `ef3eeb8 test: enforce >=64 inventory and expand factual scorecard contracts`
...
Automated patch release cut by `scripts/release/auto_release.py` from
commits merged into `main` since `v1.0.23`. See
`docs/releases/v1.0.24.md` for full detail.

### Commits included (v1.0.24)

- `1fb1189 feat(assessment): add independent evaluation pack and scorecard automation`
- `da26e9d fix: clear diagnostics errors/warnings and stabilize cloud bridge lint`
- `a71061b feat: add real clisonix cloud bridge for auth and billing`
...
Automated patch release cut by `scripts/release/auto_release.py` from
commits merged into `main` since `v1.0.22`. See
`docs/releases/v1.0.23.md` for full detail.

### Commits included (v1.0.23)

- `f28269a ci: harden Hetzner autodeploy and document setup`
- `6d6d9aa Integrate canonical GRAM service adapter`
- `75ee594 feat(web): redirect root path to /dna-ui`
...
Automated patch release cut by `scripts/release/auto_release.py` from
commits merged into `main` since `v1.0.21`. See
`docs/releases/v1.0.22.md` for full detail.

### Commits included (v1.0.22)

- `78fc8a4 Unify shell UI with live runtime contract`
...
Automated patch release cut by `scripts/release/auto_release.py` from
commits merged into `main` since `v1.0.20`. See
`docs/releases/v1.0.21.md` for full detail.

### Commits included (v1.0.21)

- `083649d fix: align Ruff formatter configuration`
...
Automated patch release cut by `scripts/release/auto_release.py` from
commits merged into `main` since `v1.0.19`. See
`docs/releases/v1.0.20.md` for full detail.

### Commits included (v1.0.20)

- `acc22e1 fix: rebuild application images during autodeploy`
