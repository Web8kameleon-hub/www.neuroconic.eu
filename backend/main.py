...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Neurosonic Backend API")
    parser.add_argument("--port", type=int, default=8000, help="Port per serverin API")
    parser.add_argument(
        "--host", type=str, default="0.0.0.0", help="Host per serverin API"
    )
